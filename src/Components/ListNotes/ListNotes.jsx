        ...
        <div>
            {
                notes.map((item, index) =>
                    <div className="card mt-3" key={item.titulo}>
                        <div className="card-body expansible-container">
                            ...
                            <h6 className="card-subtitle mb-2 text-body-secondary">{item.contenido.length}</h6>
                            <h6 className="card-subtitle mb-2 text-body-secondary">{item.contenido.slice(0, 70).length}</h6>
